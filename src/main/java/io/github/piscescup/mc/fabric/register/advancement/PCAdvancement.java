package io.github.piscescup.mc.fabric.register.advancement;

import io.github.piscescup.mc.fabric.datagen.advancements.PCAdvancementTabContainer;
import io.github.piscescup.mc.fabric.datagen.advancements.PCAdvancementTabGenerator;
 ...
 * @Date 2025-05-20
 * @since 1.1.0
 * @see PCAdvancementTabGenerator
 * @see PCAdvancementTabContainer
 * @see PCAdvancementProviderFactory
 */
public class PCAdvancement {
    ...
    // private TriFunction<String, RegistryWrapper.WrapperLookup, Consumer<AdvancementEntry>, AdvancementCriterion<?>>
    //     lazyCriterionFunction =
    //     (name, lookup, exporter) -> {
    //
    //     };
